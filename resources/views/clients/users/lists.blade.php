        ...
        <thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route('users.edit', ['id'=>$item->id])}}" class="btn btn-warning sm">Sửa</a>
                    </td>
                    <td>
                        <a onclick="return confirm('Bạn có chắc chắn muốn xóa')" href="{{route('users.delete', ['id'=>$item->id])}}" class="btn btn-danger sm">Xóa</a>
                    </td>
                </tr>
                </tr>
                @endforeach
